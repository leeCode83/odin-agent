...
import { ClipboardList, Loader2, Check, X, AlertCircle, TrendingUp, TrendingDown } from "lucide-react"
...
export function PlanSection() {
  ...
  const { ddReport, tradePlan, setTradePlan, walletAddress } = useDashboard()
  const { loading: planLoading, generatePlan } = usePlanning()
  ...
  const handleGenerate = () => {
    if (!ddReport || !walletAddress) return
    generatePlan(ddReport, "dashboard-user", walletAddress)
  }
            ...
            <CardContent className="space-y-4">
              {!ddReport ? (
                ...
                <Button
                  ...
                  disabled={planLoading || !walletAddress}
